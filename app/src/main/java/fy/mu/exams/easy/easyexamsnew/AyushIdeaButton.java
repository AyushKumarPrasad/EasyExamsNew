...
public class AyushIdeaButton extends AppCompatActivity
{
    WebView web1 ;
    ImageView back ;
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.ayushideabutton);

  /*      web1 = (WebView) findViewById(R.id.webidea);
        ...
        web1.loadUrl("file:///android_asset/AyushIdea.html");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent ayush = new Intent(AyushIdeaButton.this , First_java.class);
                startActivity(ayush);
            }
        });  */


        back = (ImageView) findViewById(R.id.back_idea);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Intent intent = new Intent(AyushIdeaButton.this,Home.class);
